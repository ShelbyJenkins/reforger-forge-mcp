...
import { formatWorkbenchRefusalMessage } from "../workbench/refusal-remedy.js";
  ...
  server.registerTool(
    ...
    async () => {
      try {
        ...
        const msg = e instanceof WorkbenchError
          ? formatWorkbenchRefusalMessage(e, { operation: "wb_state" })
